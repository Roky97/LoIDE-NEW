    ...
    return (
        <div style={{ lineHeight: "20px" }}>
            ...
            <p style={{ marginBottom: "40px" }} className="ion-text-center">
                <em>
                    LoIDE PWA is a Progressive Web App IDE for Logic Programming
                </em>
                <br />
            </p>
            ...
            <p className="ion-text-justify">
                If you have any questions or suggestions, please write an e-mail
                to{" "}
                <em>
            ...
            <p className="ion-text-justify">
                <strong>
                    ...
                    responsibility for any use that goes out of the scopes of
                    such licenses.
                </strong>
            </p>

...
export const LanguagesDataStore = new Store<ILanguagesStore>(initialLanguagesDataStore);
...
export const RunSettingsStore = new Store<IRunSettingsStore>(initialRunSettingsStore);
...
export const SocketStatusStore = new Store<ISocketStatusStore>(initialSocketStatusStore)